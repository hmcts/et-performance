...
object ET_Citizen {
  ...
  .group("ET_CTZ_032_CaseNumberCheckLanding") {
  ...
  ==========================================================================================*/
   ...
   .group("ET_CTZ_033_EnterCaseNumber") {
      exec(http("ET_CTZ_033_EnterCaseNumber")
  ...
  group("ET_CTZ_034_ChecklistContinue") {
    exec(http("ET_CTZ_034_ChecklistContinue")
      .get(baseUrlET + "/case-list-check")
      .headers(CitUICommonHeader)
      .check(CsrfCheck.save)
      .check(status.is(200))
  ...
  ==========================================================================================*/
   ...
   group("ET_CTZ_040_SelfAssignment") {
      exec(http("ET_CTZ_040_SelfAssignment")
  ...
  .group("ET_CTZ_050_SelfAssignmentCheck") {
      exec(http("ET_CTZ_050_SelfAssignmentCheck")
...
*/
  ...
  .group("ET_CTZ_190_ConfirmRespondentName") {
      exec(http("ET_CTZ_190_ConfirmRespondentName")
  ...
  .group("ET_CTZ_200_TypeOfOrganisation") {
      exec(http("ET_CTZ_200_TypeOfOrganisation")
  ...
  .group("ET_CTZ_210_Respondentddress") {
      exec(http("ET_CTZ_210_Respondentddress")
  ...
  .group("ET_CTZ_220_NameOfPreferredContact") {
      exec(http("ET_CTZ_220_NameOfPreferredContact")
  ...
  .group("ET_CTZ_230_DXAddress") {
      exec(http("ET_CTZ_230_DXAddress")
  ...
  .group("ET_CTZ_240_ContactNumber") {
      exec(http("ET_CTZ_240_ContactNumber")
  ...
  .group("ET_CTZ_250_ContactNumber") {
      exec(http("ET_CTZ_250_ContactPreferences")
  ...
  .group("ET_CTZ_270_HearingPreferences") {
      exec(http("ET_CTZ_270_HearingPreferences")
  ...
  .group("ET_CTZ_280_ReasonableAdjustments") {
      exec(http("ET_CTZ_280_ReasonableAdjustments")
  ...
  .group("ET_CTZ_290_RespondentEmployees") {
      exec(http("ET_CTZ_290_RespondentEmployees")
  ...
  .group("ET_CTZ_300_RespondentSites") {
      exec(http("ET_CTZ_300_RespondentSites")
  ...
  .group("ET_CTZ_310_RespondentSiteEmployees") {
      exec(http("ET_CTZ_310_RespondentSiteEmployees")
  ...
  .group("ET_CTZ_320_CheckAnswersHearingPreferences") {
      exec(http("ET_CTZ_320_CheckAnswersHearingPreferences")
  ...
  group("ET_CTZ_330_ET3ResponseTaskList") {
  ...
  .group("ET_CTZ_340_ACASEarlyConciliationStart") {
 ...
 /*======================================================================================
  ...
  .group("ET_CTZ_350_ACASEarlyConciliation") {
      exec(http("ET_CTZ_350_ACASEarlyConciliation")
  ...
  .group("ET_CTZ_360_ClaimantEmploymentDates") {
      exec(http("ET_CTZ_360_ClaimantEmploymentDates")
  ...
  .group("ET_CTZ_370_ClaimantContinuedEmployment") {
      exec(http("ET_CTZ_370_ClaimantContinuedEmployment")
  ...
  .group("ET_CTZ_380_ClaimantJobTitle") {
      exec(http("ET_CTZ_380_ClaimantJobTitle")
  ...
  .group("ET_CTZ_390_ClaimantWeeklyHours") {
      exec(http("ET_CTZ_390_ClaimantWeeklyHours")
 ...
 .group("ET_CTZ_400_CheckYourAnswers") {
      exec(http("ET_CTZ_400_CheckYourAnswers")
  ...
  .group("ET_CTZ_410_ClaimantPayDetails") {
      exec(http("ET_CTZ_410_ClaimantPayDetails")
  ...
  .group("ET_CTZ_420_ClaimantNoticePeriod") {
      exec(http("ET_CTZ_420_ClaimantNoticePeriod")
  ...
  .group("ET_CTZ_430_ClaimantPensionBenefits") {
      exec(http("ET_CTZ_430_ClaimantPensionBenefits")
  ...
  .group("ET_CTZ_440_CheckYourAnswers") {
      exec(http("ET_CTZ_440_CheckYourAnswers")
...
val RespondentET3ContestTheClaim =
  ...
  group("ET_CTZ_450_ET3ResponseTaskList") {
  ...
  .group("ET_CTZ_460_ContestTheClaimStart") {
  ...
  .group("ET_CTZ_470_ContestTheClaim") {
      exec(http("ET_CTZ_470_ContestTheClaim")
  ...
  .group("ET_CTZ_480_ContestTheClaimReason") {
      exec(http("ET_CTZ_480_ContestTheClaimReason")
  ...
  .group("ET_CTZ_490_CheckYourAnswers") {
      exec(http("ET_CTZ_490_CheckYourAnswers")
...
val RespondentET3CheckYourAnswers =
  ...
  group("ET_CTZ_500_ET3ResponseTaskList") {
  ...
  .group("ET_CTZ_510_ET3CheckYourAnswers") {
  ...
  .group("ET_CTZ_520_SubmitET3Application") {
    exec(http("ET_CTZ_520_SubmitET3Application")
  ...
  .group("ET_CTZ_530_ET3ResponseContinue") {
